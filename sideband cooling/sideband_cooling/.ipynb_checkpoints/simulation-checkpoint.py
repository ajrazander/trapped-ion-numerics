...
class SidebandCooling():
    ...
    def optimal(self, N_pulses, rsb_order):
        ...
        # bounded gradient descent optimization
        t0s = [rsb_order * np.pi/self.omega] * N_pulses
        res = fmin_l_bfgs_b(self.comp_nbar_opt, t0s, bounds=[(t0s[0]*0.01, t0s[0]*50)]*N_pulses, pgtol=1e-14, factr=1e2, fprime=None, args=params, approx_grad=1, epsilon=1e-17)
